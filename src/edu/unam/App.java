package edu.unam;
import edu.unam.controladores.ControladorVistaCosechas;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        ServicioCosecha co = new ServicioCosecha(repo);
        ServicioEntrega en = new ServicioEntrega(repo);
        ServicioRegistro reg = new ServicioRegistro(repo);
